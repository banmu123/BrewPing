...
#ifndef BREWPING_SWIFT_H
#define BREWPING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BrewPing",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC8BrewPing24WatchConnectivityManager")
